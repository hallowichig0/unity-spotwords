...
public class destroyObj8a : MonoBehaviour {
	...
	void Update()
	{
		...
		if (BoxSlot.enabled == true && BoxSlot2.enabled == true && BoxSlot3.enabled == true && BoxSlot4.enabled == true && BoxSlot5.enabled == true) {
			...
			SceneManager.LoadScene ("ObjectLvl3b");
			PlayerPrefs.Save ();
		}
