...
public class destroyObj9b : MonoBehaviour {
	...
	void Start () {
		...
		BoxSlot4 = BoxSlot4.GetComponent <Canvas> ();
		BoxSlot5 = BoxSlot5.GetComponent <Canvas> ();
		BoxSlot6 = BoxSlot6.GetComponent <Canvas> ();
		BoxSlot7 = BoxSlot7.GetComponent <Canvas> ();
	...
	void Update()
	{
		...
		if (BoxSlot.enabled == true && BoxSlot2.enabled == true && BoxSlot3.enabled == true && BoxSlot4.enabled == true && BoxSlot5.enabled == true && BoxSlot6.enabled == true && BoxSlot7.enabled == true) {
			...
			SceneManager.LoadScene ("ObjectLvl4c");
			PlayerPrefs.Save ();
		}
